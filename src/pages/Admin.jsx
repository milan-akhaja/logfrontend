          ...
          <div className="admin-card">
            ...
            <form onSubmit={handleSaveHeroConfig} style={{ padding: '20px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '700px' }}>
                ...
                <h3 style={{ borderBottom: '1px solid var(--admin-border)', paddingBottom: '8px', fontSize: '15px', fontWeight: '700' }}>PC Layout Settings</h3>
                
                <div className="admin-form-group">
                  <label className="admin-label">Tagline text (small preview text)</label>
                  <input 
                    type="text" 
                    className="admin-input" 
                    placeholder="e.g. New Season Drop" 
                    value={heroConfig.tagline}
                    onChange={(e) => setHeroConfig(prev => ({ ...prev, tagline: e.target.value }))}
                  />
                </div>

                <div className="admin-form-group">
                  <label className="admin-label">Main Title text (supports newline \n)</label>
                  <textarea 
                ...
                <div className="admin-form-group">
                  <label className="admin-label">Description paragraphs/subtitle</label>
                  <textarea 
                    className="admin-textarea" 
                    placeholder="Brief hero intro text..." 
                    value={heroConfig.desc}
                    onChange={(e) => setHeroConfig(prev => ({ ...prev, desc: e.target.value }))}
                    rows="3"
                  />
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                  <div className="admin-form-group">
                    <label className="admin-label">Button 1 Accent Title</label>
                    <input 
                      type="text" 
                      className="admin-input" 
                      value={heroConfig.button1Text}
                      onChange={(e) => setHeroConfig(prev => ({ ...prev, button1Text: e.target.value }))}
                    />
                  </div>
                  <div className="admin-form-group">
                    <label className="admin-label">Button 1 Accent Link Target</label>
                    <input 
                      type="text" 
                      className="admin-input" 
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                  <div className="admin-form-group">
                    <label className="admin-label">Button 2 Outline Title</label>
                    <input 
                      type="text" 
                      className="admin-input" 
                      value={heroConfig.button2Text}
                      onChange={(e) => setHeroConfig(prev => ({ ...prev, button2Text: e.target.value }))}
                    />
                  </div>
                  <div className="admin-form-group">
                    <label className="admin-label">Button 2 Outline Link Target</label>
                    <input 
                      type="text" 
                      className="admin-input" 
                      value={heroConfig.button2Link}
                      onChange={(e) => setHeroConfig(prev => ({ ...prev, button2Link: e.target.value }))}
                    />
                  </div>
                </div>
            ...
            <form onSubmit={async (e) => {
              ...
              try {
                ...
                if (res.ok) {
                  ...
                  onToast('Failed to update Coming Soon settings.');
                }
              } catch (err) {
                console.error(err);
            ...
            <form onSubmit={async (e) => {
              ...
              try {
                ...
                if (res.ok) {
                  ...
                  onToast('Failed to update New In configuration.');
                }
              } catch (err) {
                console.error(err);
